...
WOHOUUU everything is done and saved. Now, last thing - I promise - we need to upload our work to GitHub because of few things: 

- You never know when will R decide to not cooperate with you, so you will have your work saved online too

- Also, your computer can decide to not work, because of these all assessments it needs to do with you
...
- It is very clever to upload your work continuously because GitHub will then have saved all of your history files which you may need if you realize you did something absolutely wrong :D 

So, as your RStudio is already connected to Git, this process is easy. 

1. Click on Git in right top window

![](pictures/Obrázok15.png)
2. Mark all new or changed files and folders you want to upload to GitHub. 
3. Click Commit

![](pictures/Obrázok16.png)
4. Write informative commit comment 
5. Press Commit
...
11. Check your repository on GitHub

![](pictures/Obrázok20.png)

ALL DONE! 
So, are you lost at the same level as you were at the begining of this tutorial? I hope not! 
